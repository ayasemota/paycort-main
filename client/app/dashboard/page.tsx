    ...
    <main className="min-h-screen bg-white pb-32 pt-12 px-6 font-sans text-black animate-in fade-in duration-500">
      <div className="max-w-md mx-auto">
        ...
        <header className="flex justify-between items-center mb-10">
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Tax Profile</p>
            <h1 className="text-2xl font-black uppercase tracking-tighter">{firstName}</h1>
          </div>
...
<div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
  <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-zinc-400">Monthly Income</p>
  ...
  <div className="mt-2 flex items-center gap-1 px-2 py-0.5 bg-zinc-50 rounded-md border border-zinc-100">
    <span className="text-[9px] font-bold text-zinc-400">EST. TAX:</span>
    <span className="text-[9px] font-black text-black">₦12,500</span>
  </div>
</div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-2 gap-4 mb-8">
          <div className="p-6 rounded-3xl bg-zinc-900 text-white text-left">
            <p className="text-[10px] font-black uppercase tracking-widest text-zinc-500 mb-1">Monthly Target</p>
            <p className="text-lg font-black">₦500k</p>
          </div>
          <div className="p-6 rounded-3xl border-2 border-zinc-100 text-left">
            <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-1">Weekly Target</p>
        ...
        <section className="space-y-3 mb-10">
          <div className="flex justify-between items-center p-5 rounded-2xl bg-zinc-50 border border-zinc-100">
            <span className="text-xs font-black uppercase tracking-widest text-zinc-400">Total Income</span>
            <span className="font-bold text-brand-green">+₦{balance.toLocaleString()}</span>
          </div>
          <div className="flex justify-between items-center p-5 rounded-2xl bg-zinc-50 border border-zinc-100">
            <span className="text-xs font-black uppercase tracking-widest text-zinc-400">Total Expenses</span>
        ...
        <section className="mb-8">
          <div className="flex justify-between items-end mb-6">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Recent Activity</h3>
            <button className="text-[10px] font-black uppercase tracking-widest text-brand-green">View All</button>
          </div>
