    ...
    <section id="about-us" className="py-24 md:py-36 bg-white overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          <h2 className="text-2xl font-extrabold tracking-tight text-zinc-900 md:text-5xl leading-[1.1]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            <div className="relative z-10 max-w-lg">
              ...
              <h3 className="text-xl md:text-3xl font-bold mb-6">Built for the Nigerian Dream.</h3>
          ...
          >
             ...
             <p className="text-lg md:text-2xl font-bold text-zinc-900 leading-snug">
          ...
          >
            <div className="text-white">
              <div className="flex -space-x-3 mb-4" onClick={() => navigateTo('/register')}> 
                {[1, 2, 3, 4].map((i) => (
              ...
              <h4 className="text-xl md:text-2xl font-bold">Join the waitlist.</h4>
              <p className="text-brand-green-dark opacity-80 font-medium text-sm">Be the first to experience simpler taxes.</p>
            </div>
