  ...
  return (
    <section className="relative flex flex-col items-center justify-start overflow-hidden px-6 pt-24 md:pt-36">
      ...
      <div className="container relative z-10 mx-auto text-center">
        ...
        >
          A smart AI tool that helps Nigerians see, track, and plan their taxes
          in real time powered by clarity, not confusion.
        </motion.p>
        ...
        >
          <Button className="w-full sm:w-auto h-12 rounded-full bg-zinc-900 px-8 text-sm font-bold text-white transition-all hover:bg-zinc-800" onClick={() => navigateTo('/register')}>
            Get Started Free
          </Button>
          <button onClick={() => navigateTo("#how-it-works")} className="group flex items-center gap-2 text-sm font-bold text-zinc-900 px-6 py-2">
            See how it works{" "}
            <ArrowRight
              size={16}
